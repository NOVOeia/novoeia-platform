...
function normalizeStorefront(partner: Record<string, unknown>) {
  ...
  const brand = {
    ...
    headerBackgroundColor: brandBlock.headerBackgroundColor || DEFAULT_BRAND.headerBackgroundColor,
...
function buildCheckoutPayload(
  ...
  return {
    ...
    theme: {
      ...
      headerBackgroundColor: storefront.brand.headerBackgroundColor || '#FFFFFF',
      surfaceColor: '#FFFFFF',
