...
export default function PublicCheckoutPage({
  checkoutData = DEMO_CHECKOUT_DATA,
}) {
  ...
  function handlePayment() {
    if (!email.trim()) {
      window.alert('Escribe tu correo electrónico.');
      return;
    }
    ...
    /*
      Próxima etapa:
      aquí llamaremos la función de Stripe para crear
      la sesión y mostrar Stripe Payment Element.
    */

    window.alert(
      'La página está lista. El siguiente paso será conectar Stripe.',
    );
  }
